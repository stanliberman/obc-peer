...
CHAINCODE_NAME=`./obc-peer chaincode deploy -p github.com/hyperledger-incubator/obc-peer/openchain/example/chaincode/asset_manager \
	-c '{"Function":"init", "Args": ["admin_user", "pickle"]}'`
...
./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
	-c '{"Function": "admin", "Args": ["admin_user", "issuer_user", "1110"]}'

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "admin", "Args": ["admin_user", "user1", "0010"]}'

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "admin", "Args": ["admin_user", "user2", "0010"]}'

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "admin", "Args": ["admin_user", "other_admin_user", "0011"]}'

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "admin", "Args": ["admin_user", "auditor_user", "0000"]}' 

./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
	-c '{"Function": "issue", "Args": ["issuer_user", "10000"]}'

./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
	-c '{"Function": "transact", "Args": ["issuer_user", "issuer_user", "user1", "1"]}'
...
# ./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "inituser", "Args": ["admin_user", "issuer_user", "Will", "Smith", "1110"]}' 2>&1 >$LOG_FILE

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "inituser", "Args": ["admin_user", "transactor_user", "Joe", "Smith", "0010"]}' 2>&1 >$LOG_FILE

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "inituser", "Args": ["admin_user", "other_admin_user", "Jane", "Doe", "0011"]}' 2>&1 >$LOG_FILE

#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "inituser", "Args": ["admin_user", "auditor_user", "Michael", "Moore", "0000"]}' 2>&1 >$LOG_FILE


# This must fail
#./obc-peer chaincode invoke -u $USER -n $CHAINCODE_NAME \
#	-c '{"Function": "inituser", "Args": ["transactor_user", "auditor_user", "James", "Hook", "0001"]}' 2>&1 >$LOG_FILE
